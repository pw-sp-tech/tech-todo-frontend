...
$.MyAdmin.leftSideBar = {
    activate: function () {
        ...
        $(window).on("click", function (e) {
            ...
            if (!$target.hasClass('bars') && _this.isOpen() && $target.parents('#leftsidebar').length === 0 && $target.parents('#topsidebar').length === 0) {
...
$(".rightSetting .btn-theme-light").on("click", function () {
    $("body").removeClass("dark submenu-closed");
    $("body").addClass("light submenu-closed");
    var theme = "light";
    localStorage.setItem("theme", theme);
}), $(".rightSetting .btn-theme-dark").on("click", function () {
    $("body").removeClass("light submenu-closed");
    $("body").addClass("dark submenu-closed");
